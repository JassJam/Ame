package("ame.imgui")
    ...
    on_install("macosx", "linux", "windows", "mingw", "android", "iphoneos", function (package)
        ...
        local content = io.readfile("imconfig.h")
        content = content:gsub("//#define IMGUI_DISABLE_OBSOLETE_FUNCTIONS", "#define IMGUI_DISABLE_OBSOLETE_FUNCTIONS")
        content = content:gsub("//#define IMGUI_DISABLE_OBSOLETE_KEYIO", "#define IMGUI_DISABLE_OBSOLETE_KEYIO")
        content = content:gsub("//#define IMGUI_DEFINE_MATH_OPERATORS", "#define IMGUI_DEFINE_MATH_OPERATORS")
        io.writefile("imconfig.h", content)
