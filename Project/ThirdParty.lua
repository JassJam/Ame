...
includes("ThirdParty/concurrencpp.lua")
includes("ThirdParty/kangaru.lua")
includes("ThirdParty/mimalloc.lua")
includes("ThirdParty/octree.lua")
...
add_requires("ame.imgui v1.91.1-docking", {
    configs = {
        shared = true,
        freetype = true
    }
