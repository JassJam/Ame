...
namespace Ame::Ecs
{
    ...
    public:
        [[nodiscard]]
        MeshModel::CreateDesc CreateModelDesc(Rhi::IRhiDevice* rhiDevice) const;

        [[nodiscard]]
        Co::result<MeshModel::CreateDesc> CreateModelDescAsync(Rhi::IRhiDevice* rhiDevice) const;

    private:
        void CreateBufferResources(MeshModel::CreateDesc& createDesc,
