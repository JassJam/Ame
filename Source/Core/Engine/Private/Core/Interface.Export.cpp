...
Ame_IBaseObject_t* Ame_IBaseObject_QueryInterface(Ame_IBaseObject_t* objectHandle,
...
Ame_BaseObject_QueryInterface_t Ame_IBaseObject_SetQueryInterface(
    Ame_IBaseObject_t*              objectHandle,
    Ame_BaseObject_QueryInterface_t callback)
{
    ...
    if (impl)
    {
        return std::bit_cast<Ame_BaseObject_QueryInterface_t>(
            std::exchange(impl->QueryInterfaceCallback,
                          std::bit_cast<Ame::IObjectWithCallback::QueryCallback>(callback)));
    }
    return nullptr;
}
