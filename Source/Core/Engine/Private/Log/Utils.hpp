...
{
    [[nodiscard]]
    inline spdlog::level::level_enum GetSpdlogLevel(LogLevel level)
    {
        switch (level)
        {
    ...
    [[nodiscard]]
    inline LogLevel GetLogLevel(spdlog::level::level_enum level)
    {
        switch (level)
        {
        ...
        default                     : return LogLevel::Disabled;
        }
    }

    [[nodiscard]]
    inline spdlog::file_event_handlers GetSpdlogFileEventHandlers(LogFileEvent events)
    {
