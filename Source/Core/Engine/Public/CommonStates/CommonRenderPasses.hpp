...
namespace Ame::Rhi
{
    ...
    inline constexpr UId IID_CommandRenderPass{ 0xcf6184b,
                                                0xe2f9,
                                                0x4435,
                                                { 0xb2, 0xa1, 0x79, 0x4e, 0xfe, 0xf7, 0xf, 0x20 } };

    /// <summary>
    /// All common render passes can use cached render pass.
    /// </summary>s
    class AME_ENGINE_API CommonRenderPass : public IObjectWithCallback,
