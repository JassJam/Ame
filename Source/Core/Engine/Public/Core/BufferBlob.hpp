...
namespace Ame
{
    ...
    inline constexpr UId IID_DataBlob{ 0x99e53e10,
                                       0x55d1,
                                       0x4e81,
                                       { 0x87, 0x1d, 0x9, 0xc5, 0x80, 0x6, 0xd, 0x43 } };
    ...
    inline constexpr UId IID_RawDataBlob{ 0xcd902203,
                                          0xb43c,
                                          0x48ca,
                                          { 0x9c, 0x6a, 0x62, 0x5a, 0xc4, 0xc9, 0x8d, 0x5b } };
    ...
    private:
        IMPLEMENT_INTERFACE_CTOR(RawDataBlob,
    ...
    public:
        ...
        [[nodiscard]]
        const void* GetConstDataPtr() const override
        {
            return m_Data.data();
        }
        ...
        template<typename Ty>
        [[nodiscard]]
        const Ty* GetConstDataPtr() const
        {
