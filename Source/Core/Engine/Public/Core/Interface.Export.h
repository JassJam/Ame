...
typedef Ame_IBaseObject_t*(AME_CDECL* Ame_BaseObject_QueryInterface_t)(
...
extern "C"
{
    AME_ENGINE_C(int, Ame_IBaseObject_AddRef(Ame_IBaseObject_t* objectHandle));
    AME_ENGINE_C(int, Ame_IBaseObject_Release(Ame_IBaseObject_t* objectHandle));
