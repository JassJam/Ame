...
#define AmeCreateRawObject(Ty, ...)                                                                \
    (static_cast<Ame::IObject*>(Ame::ObjectAllocator<Ty>()(__VA_ARGS__)))
...
#define IMPLEMENT_QUERY_INTERFACE_DECL()                                                           \
    void DILIGENT_CALL_TYPE QueryInterface(const Ame::INTERFACE_ID& iid, IObject** outObject)      \
        override
...
#define IMPLEMENT_QUERY_INTERFACE_SUBOJECTS2_BODY(InterfaceID1,                                    \
                                                  InterfaceID2,                                    \
                                                  ParentClassName,                                 \
                                                  ...)                                             \
    {                                                                                              \
...
#define IMPLEMENT_QUERY_INTERFACE_IN_PLACE_SUBOJECTS2(InterfaceID1,                                \
                                                      InterfaceID2,                                \
                                                      ParentClassName,                             \
                                                      ...)                                         \
    IMPLEMENT_QUERY_INTERFACE_DECL()                                                               \
    IMPLEMENT_QUERY_INTERFACE_SUBOJECTS2_BODY(InterfaceID1,                                        \
                                              InterfaceID2,                                        \
                                              ParentClassName,                                     \
                                              __VA_ARGS__)
