...
// TODO: Add color_view ? and add other colors thing to have same logic instead of copy_paste
// default_c_format
namespace imcxx
{
    /// <summary>
    ...
    public:
              ...
              const float*        ref_col = nullptr)
        {
            ...
            constexpr float to_ratio =
                impl::is_imvec4_v<_Ty> || std::is_floating_point_v<inner_type> ? 1.f : 255.f;
