    ...
    public:
             ...
             ImGuiSliderFlags flags  = 0)
        {
            ...
            static_assert(type != ImGuiDataType_COUNT,
                          "Invalid type was passed to 'ImGui::DragScalar()'");
#if _HAS_CXX20
            m_Result._Value = ImGui::DragScalar(impl::get_string(label),
                                                type,
                                                std::bit_cast<void*>(v),
                                                speed,
        ...
        /// <summary>
        /// Calls 'ImGui::DragScalarN' with a smaller or equal to array size 'v', where v is
        /// contiguous-pointer
        /// </summary>
        template<typename _StrTy, typename _Ty>
        drag(pointer,
             ...
             ImGuiSliderFlags flags  = 0)
        {
            static constexpr ImGuiDataType type = impl::to_imdatatype<_Ty>();
            static_assert(type != ImGuiDataType_COUNT,
                          "Invalid type was passed to 'ImGui::DragScalarN()'");
#if _HAS_CXX20
            m_Result._Value = ImGui::DragScalarN(impl::get_string(label),
                                                 type,
                                                 std::bit_cast<void*>(v),
                                                 size,
                                                 speed,
        ...
        /// <summary>
        /// Calls 'ImGui::DragScalarN' with a smaller or equal to array size 'v', overload for
        /// 'ImVec2'
        /// </summary>
