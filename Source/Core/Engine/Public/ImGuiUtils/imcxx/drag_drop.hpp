...
namespace imcxx
{
    ...
    public:
        ...
        drag_drop_source(const char*        type,
                         const void*        data,
                         size_t             sz,
                         ImGuiCond          cond  = 0,
        ...
        /// Strings starting with '_' are reserved for dear imgui internal types. Data is copied and
    ...
    public:
        ...
        drag_drop_target(const ImGuiPayload*& out_data,
                         const char*          type,
                         ImGuiDragDropFlags   flags = 0)
            : drag_drop_target()
        {
        ...
        /// <summary>
        /// accept contents of a given type. If ImGuiDragDropFlags_AcceptBeforeDelivery is set you
