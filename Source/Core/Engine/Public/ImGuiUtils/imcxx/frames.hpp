...
{
    /// <summary>
    /// start a new Dear ImGui frame, you can submit any command from this point until
    /// Render()/EndFrame().
    /// </summary>
    ...
    public:
        template<typename _PlatNewFrameFnTy,
                 typename = std::enable_if_t<std::is_invocable_v<_PlatNewFrameFnTy>>>
    ...
    /// </summary>
    template<typename _PlatRenderFnTy,
             typename = std::enable_if_t<std::is_invocable_v<_PlatRenderFnTy, ImDrawData*>>>
