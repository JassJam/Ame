    ...
    public:
               ...
               ImGuiSliderFlags flags  = 0)
        {
            ...
            static_assert(type != ImGuiDataType_COUNT,
                          "Invalid type was passed to 'ImGui::SliderScalar()'");
#if _HAS_CXX20
            m_Result._Value = ImGui::SliderScalar(impl::get_string(label),
                                                  type,
                                                  std::bit_cast<void*>(v),
        ...
        /// <summary>
        /// Calls 'ImGui::SliderScalarN' with a smaller or equal to array size 'v', where v is
        /// contiguous-pointer
        /// </summary>
        template<typename _StrTy, typename _Ty>
        slider(pointer,
               ...
               ImGuiSliderFlags flags  = 0)
        {
            static constexpr ImGuiDataType type = impl::to_imdatatype<_Ty>();
            static_assert(type != ImGuiDataType_COUNT,
                          "Invalid type was passed to 'ImGui::SliderScalarN()'");
#if _HAS_CXX20
            m_Result._Value = ImGui::SliderScalarN(impl::get_string(label),
                                                   type,
                                                   std::bit_cast<void*>(v),
                                                   size,
                                                   std::bit_cast<const void*>(&v_min),
        ...
        slider(angle,
               ...
               ImGuiSliderFlags flags         = 0)
            : scope_wrap(ImGui::SliderAngle(impl::get_string(label),
                                            v_rad,
                                            v_degrees_min,
                                            v_degrees_max,
                                            format,
        ...
        slider(array<_ViewSize>        arr_size,
               const _StrTy&           label,
        ...
        /// <summary>
        /// Calls 'ImGui::SliderScalarN' with a smaller or equal to array size 'v', overload for
        /// 'ImVec2'
        /// </summary>
