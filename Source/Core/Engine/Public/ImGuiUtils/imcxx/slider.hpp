...
namespace imcxx
{
    ...
    public:
        ...
        slider(const _StrTy& label, _Ty* v, _Ty v_min, _Ty v_max, const char* format = impl::default_c_format<_Ty>,
...
#if _HAS_CXX20
            m_Result._Value = ImGui::SliderScalar(impl::get_string(label), type, std::bit_cast<void*>(v),
                                                  std::bit_cast<const void*>(&v_min),
                                                  std::bit_cast<const void*>(&v_max), format, flags);
#else
            m_Result._Value = ImGui::SliderScalar(impl::get_string(label), type, reinterpret_cast<void*>(v),
                                                  reinterpret_cast<const void*>(&v_min),
                                                  reinterpret_cast<const void*>(&v_max), format, flags);
#endif
        }
        ...
        slider(const _StrTy& label, _Ty& v, _Ty v_min, _Ty v_max, const char* format = impl::default_c_format<_Ty>,
               ImGuiSliderFlags flags = 0) : slider(label, &v, v_min, v_max, format, flags)
        {
        }
        ...
        /// </summary>
        template<typename _StrTy, typename _Ty>
        slider(pointer, const _StrTy& label, _Ty* v, size_t size, _Ty v_min, _Ty v_max,
               const char* format = impl::default_c_format<_Ty>, ImGuiSliderFlags flags = 0)
        {
            static constexpr ImGuiDataType type = impl::to_imdatatype<_Ty>();
            static_assert(type != ImGuiDataType_COUNT, "Invalid type was passed to 'ImGui::SliderScalarN()'");
#if _HAS_CXX20
            m_Result._Value = ImGui::SliderScalarN(impl::get_string(label), type, std::bit_cast<void*>(v), size,
                                                   std::bit_cast<const void*>(&v_min),
                                                   std::bit_cast<const void*>(&v_max), format, flags);
#else
            m_Result._Value = ImGui::SliderScalarN(impl::get_string(label), type, reinterpret_cast<void*>(v), size,
                                                   reinterpret_cast<const void*>(&v_min),
                                                   reinterpret_cast<const void*>(&v_max), format, flags);
#endif
        }
        ...
        slider(angle, const _StrTy& label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f,
        ...
        slider(array<_ViewSize> arr_size, const _StrTy& label, std::array<_Ty, _Size>* v, _Ty v_min, _Ty v_max,
               const char* format = impl::default_c_format<_Ty>, ImGuiSliderFlags flags = 0)
        {
            static constexpr ImGuiDataType type = impl::to_imdatatype<_Ty>();
            static_assert(type != ImGuiDataType_COUNT, "Invalid type was passed to 'ImGui::SliderScalarN()'");
...
#if _HAS_CXX20
            m_Result._Value =
                ImGui::SliderScalarN(impl::get_string(label), type, std::bit_cast<void*>(v->data()), size,
                                     std::bit_cast<void*>(&v_min), std::bit_cast<void*>(&v_max), format, flags);
#else
            m_Result._Value = ImGui::SliderScalarN(impl::get_string(label), type, reinterpret_cast<void*>(v->data()),
                                                   size, reinterpret_cast<const void*>(&v_min),
                                                   reinterpret_cast<const void*>(&v_max), format, flags);
#endif
        }
        ...
        /// </summary>
        template<size_t _ViewSize, typename _StrTy, typename _Ty, size_t _Size>
        slider(array<_ViewSize> arr_size, const _StrTy& label, _Ty (&v)[_Size], _Ty v_min, _Ty v_max,
               const char* format = impl::default_c_format<_Ty>, ImGuiSliderFlags flags = 0)
        {
            static constexpr ImGuiDataType type = impl::to_imdatatype<_Ty>();
            static_assert(type != ImGuiDataType_COUNT, "Invalid type was passed to 'ImGui::SliderScalarN()'");
...
#if _HAS_CXX20
            m_Result._Value =
                ImGui::SliderScalarN(label, impl::get_string(label), std::bit_cast<void*>(static_cast<_Ty*>(v)), size,
                                     std::bit_cast<void*>(&v_min), std::bit_cast<void*>(&v_max), format, flags);
#else
            m_Result._Value = ImGui::SliderScalarN(impl::get_string(label), type, reinterpret_cast<void*>(v), size,
                                                   reinterpret_cast<const void*>(&v_min),
        ...
        slider(array<_ViewSize> arr_size, const _StrTy& label, ImVec2* v, float v_min, float v_max,
        ...
        /// </summary>
        template<size_t _ViewSize, typename _StrTy>
        slider(array<_ViewSize> arr_size, const _StrTy& label, ImVec4* v, float v_min, float v_max,
               const char* format = "%.3f", ImGuiSliderFlags flags = 0) :
#if _HAS_CXX20
