...
namespace Ame::Interfaces
{
    ...
    inline constexpr UId IID_Renderer{ 0x1ee289fb,
                                       0x1a56,
                                       0x4ac1,
                                       { 0x9d, 0x2b, 0x7c, 0xf3, 0x54, 0xb9, 0xa9, 0xbe } };
    ...
    public:
        [[nodiscard]]
        uint32_t GetSyncInterval() const noexcept
        {
        ...
        [[nodiscard]]
        const Math::Color4& GetClearColor() const noexcept
        {
            return m_ClearColor;
        }
    ...
    [[nodiscard]]
    AME_ENGINE_API Ptr<IRenderer> CreateRenderer(const RendererCreateDesc& createDesc);
}
