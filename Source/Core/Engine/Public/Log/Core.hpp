...
//
        ...
        #define AME_LOG_ASSERT(cond, ...)                                                          \
            AME_LOG_ASSERT_EX(AME_INTERNAL_LOGGER_INST, cond, __VA_ARGS__)
    ...
    #define AME_LOG_VALIDATE(cond, ...)                                                            \
        AME_LOG_VALIDATE_EX(AME_INTERNAL_LOGGER_INST, cond, __VA_ARGS__)
