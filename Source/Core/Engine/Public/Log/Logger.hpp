...
namespace Ame::Log
{
    ...
    inline constexpr UId IID_Logger{ 0x940017d2,
                                     0x269c,
                                     0x45b6,
                                     { 0x80, 0x3b, 0xf3, 0xc5, 0x30, 0x15, 0x1c, 0xca } };
    ...
    public:
        ...
        [[nodiscard]]
        bool CanLog([[maybe_unused]] LogLevel level) const noexcept
        {
    ...
    [[nodiscard]]
    AME_ENGINE_API Ptr<ILogger> CreateLogger(String name);
}
