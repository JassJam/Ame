...
namespace Ame::Math
{
    ...
    struct RectT
    {
        ...
        constexpr explicit RectT(const Ty& position = {}, const Ty& size = {}) noexcept
    ...
    public:
        [[nodiscard]]
        constexpr Ty TopLeft() const noexcept
        {
            return Ty(Left(), Top());
        }

        [[nodiscard]]
        constexpr Ty TopRight() const noexcept
        {
            return Ty(Right(), Top());
        }

        [[nodiscard]]
        constexpr Ty BottomLeft() const noexcept
        {
            return Ty(Left(), Bottom());
        }

        [[nodiscard]]
        constexpr Ty BottomRight() const noexcept
        {
