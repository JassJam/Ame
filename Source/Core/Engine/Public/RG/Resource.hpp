...
namespace Ame::Rg
{
    ...
    public:
        ...
        ResourceViewId(const ResourceId& resource, size_t id)
            : m_ResourceId(resource.GetId()), m_ViewId(id)
        {
        }
    ...
    public:
        [[nodiscard]]
        auto&& GetBufferDesc(this auto&& self)
        {
            return std::get<BufferHandle>(self.m_Handle).Desc;
        }

        [[nodiscard]]
        auto&& GetTextureDesc(this auto&& self)
        {
    ...
    public:
        [[nodiscard]]
        Dg::ITexture* AsTexture() const noexcept
        {
        ...
        [[nodiscard]]
        Dg::IBuffer* AsBuffer() const noexcept
        {
    ...
    public:
        [[nodiscard]]
        Dg::IBufferView* GetBufferView(size_t viewId) const noexcept
        {
        ...
        [[nodiscard]]
        Dg::ITextureView* GetTextureView(size_t viewId) const noexcept
        {
    ...
    public:
        [[nodiscard]]
        size_t CreateView(const BufferResourceViewDesc& viewDesc);
        [[nodiscard]]
        size_t CreateView(const TextureResourceViewDesc& viewDesc);
