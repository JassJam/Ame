...
namespace Ame::Window
{
    ...
    inline constexpr UId IID_Window{ 0xd04401d7,
                                     0xe3e3,
                                     0x45d8,
                                     { 0xb6, 0x6d, 0xfa, 0x5e, 0x5, 0x75, 0xd, 0x90 } };
    ...
    public:
        ...
        [[nodiscard]]
        virtual WindowEventListener& GetEventListener() = 0;
        [[nodiscard]]
        virtual IGlfwDriver* GetGlfwDriver() const = 0;

    public:
        [[nodiscard]]
        virtual GLFWwindow* GetGlfwHandle() const = 0;
    ...
    [[nodiscard]]
    AME_ENGINE_API Ptr<IWindow> CreateWindow(const WindowType&       windowType,
