...
namespace Ame
{
    ...
    inline constexpr UId IID_CoreModule{ 0xc9e70a4e, 0x1aa4, 0x4b93, { 0xb0, 0x86, 0x5, 0x31, 0x4a, 0x7, 0x80, 0x48 } };
    class CoreModule;
    ...
    inline constexpr UId IID_TimeSubmodule{ 0xbe4b917d, 0x4b7a, 0x4582, { 0x80, 0x34, 0x1, 0xdc, 0x24, 0x14, 0x74, 0x18 } };
    class TimeSubmodule;
