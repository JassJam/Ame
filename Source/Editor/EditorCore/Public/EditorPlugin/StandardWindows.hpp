...
namespace Ame::Editor
{
    ...
    inline constexpr UId IID_ConsoleEditorWindow{
        ...
        0xbe5,
        0x499d,
        { 0x92, 0xd8, 0x4c, 0xcd, 0xc7, 0xc3, 0x75, 0xb5 }
    };
    ...
    inline constexpr UId IID_ContentBrowserEditorWindow{
        ...
        0xdf78,
        0x40bd,
        { 0x83, 0x52, 0xf, 0xff, 0x94, 0x5c, 0xab, 0x8 }
    };
    inline constexpr const char* ContentBrowserEditorWindowPath =
        "Content Browser##General$Content Browser";
    ...
    inline constexpr UId IID_GameViewEditorWindow{
        ...
        0x8139,
        0x4199,
        { 0xac, 0x8b, 0xc9, 0x32, 0x79, 0x62, 0x39, 0xff }
    };
    ...
    inline constexpr UId IID_HierarchyEditorWindow{
        ...
        0x6aa9,
        0x4307,
        { 0xad, 0xa3, 0x95, 0x23, 0xe4, 0xa7, 0x59, 0xe8 }
    };
    ...
    inline constexpr UId IID_InspectorEditorWindow{
        ...
        0xce72,
        0x4583,
        { 0x81, 0x78, 0x72, 0xc1, 0x8f, 0x88, 0x7b, 0x1e }
    };
    ...
    inline constexpr UId IID_SceneViewEditorWindow{
        ...
        0x3b84,
        0x4b0f,
        { 0xa5, 0x19, 0x69, 0x67, 0x4, 0x3b, 0x90, 0xa6 }
    };
