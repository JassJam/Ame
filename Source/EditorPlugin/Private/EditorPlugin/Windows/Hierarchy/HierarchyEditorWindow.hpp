...
namespace Ame::Editor
{
    ...
    public:
        ...
        IMPLEMENT_QUERY_INTERFACE2_IN_PLACE(IID_HierarchyEditorWindow, IID_BaseEditorWindow, Base);

    public:
        HierarchyEditorWindow(IReferenceCounters* counter, ModuleRegistry& registry) :
