...
namespace Ame::Editor
{
    ...
    public:
        ...
        virtual void AddWindow(const EditorWindowCreateDesc& desc) = 0;

        virtual void RemoveWindow(IEditorWindow* window) = 0;

        virtual void ShowWindow(IEditorWindow* window) = 0;

        virtual void HideWindow(IEditorWindow* window) = 0;
    };

    [[nodiscard]] Ptr<IEditorWindowManager> CreateEditorWindowManager(ModuleRegistry& registry, RhiModule* rhiModule,
