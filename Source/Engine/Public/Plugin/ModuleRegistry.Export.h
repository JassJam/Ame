...
extern "C"
{
    ...
    AME_ENGINE_C(void, Ame_ModuleRegistry_ExposeInterface(Ame_IModuleRegistry_t* registry, Ame_IPlugin_t* owner, const Ame_UID_t* iid, Ame_IBaseObject_t* iface));
    AME_ENGINE_C(void, Ame_ModuleRegistry_DropInterface(Ame_IModuleRegistry_t* registry, const Ame_UID_t* iid));
    AME_ENGINE_C(Ame_IBaseObject_t*, Ame_ModuleRegistry_RequestInterface(Ame_IModuleRegistry_t* registry, Ame_IPlugin_t* caller, const Ame_UID_t* iid));
