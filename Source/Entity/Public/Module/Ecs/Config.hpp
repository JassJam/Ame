...
namespace Ame
{
    ...
    inline constexpr UId IID_EntityModule{ 0x3c5c3a5b, 0x2147, 0x44d9, { 0x9d, 0xda, 0x59, 0x4f, 0x89, 0x1e, 0xda, 0x8e } };
    class EntityModule;

    // {195A8AE5-5E17-4832-9C41-1B03332A14B2}
    inline constexpr UId IID_EntityStorageSubmodule{ 0x195a8ae5, 0x5e17, 0x4832, { 0x9c, 0x41, 0x1b, 0x3, 0x33, 0x2a, 0x14, 0xb2 } };
