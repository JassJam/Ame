...
namespace Ame::Gfx
{
    ...
    void DepthPrePass::BindResourcesOnce(
    ...
    void DepthPrePass::CreateResourcesOnce(
        const Rg::ResourceStorage& storage)
    {
        if (m_Technique)
        {
        ...
        Rg::Resolver& resolver)
    {
        ...
        m_PassData.DepthView = resolver.WriteTexture(c_RGDepthImage, Dg::BIND_DEPTH_STENCIL, Dg::TEXTURE_VIEW_DEPTH_STENCIL);
        ...
        Dg::IDeviceContext*        deviceContext)
    {
        ...
        deviceContext->ClearDepthStencil(dsv, Dg::CLEAR_DEPTH_FLAG, 1.f, 0, Dg::RESOURCE_STATE_TRANSITION_MODE_TRANSITION);
