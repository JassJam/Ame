...
namespace Ame::Gfx
{
    ...
    inline const Rg::ResourceId c_RGLightIndices_Transparent{
        "_LightIndices_Transparent"
    }; // RWStructuredBuffer<uint> | StructuredBuffer<uint>
    inline const Rg::ResourceId c_RGLightIndices_Opaque{
        "_LightIndices_Opaque"
    }; // RWStructuredBuffer<uint> | StructuredBuffer<uint>
    ...
    inline const Rg::ResourceId c_RGFrameDataResourceSignature_Graphics{
        "_FRS_Graphics"
    }; // Srb: [FrameDataBuffer, Samplers]
    ...
    inline const Rg::ResourceId c_RGEntityResourceSignature_Compute{
        "_ERS_Compute"
    }; // Srb: [AllTransforms, RenderInstances, AllLightInstances]
    inline const Rg::ResourceId c_RGLightingResourceSignature_Compute{
        "_LRS_Compute"
