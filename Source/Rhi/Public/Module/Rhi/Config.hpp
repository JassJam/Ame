...
namespace Ame
{
    ...
    inline constexpr UId IID_RhiModule{ 0xb8b1f60a, 0xbfb3, 0x424b, { 0x9a, 0xa4, 0x1d, 0x2d, 0x84, 0x4b, 0x9, 0x1f } };
    class RhiModule;

    // {CF40EE16-0DE3-4095-938A-FB8993CD01FD}
    inline constexpr UId IID_ImGuiSubmodule{ 0xcf40ee16, 0xde3, 0x4095, { 0x93, 0x8a, 0xfb, 0x89, 0x93, 0xcd, 0x1, 0xfd } };
    class ImGuiSubmodule;

    // {640F1A0F-8EBC-4722-931D-92EAD1EFFE74}
    inline constexpr UId IID_PlatformWindowSubmodule{ 0x640f1a0f, 0x8ebc, 0x4722, { 0x93, 0x1d, 0x92, 0xea, 0xd1, 0xef, 0xfe, 0x74 } };
    class PlatformWindowSubmodule;

    // {116F0CD7-9584-417E-BA5E-5EC61E74C7E6}
    inline constexpr UId IID_RhiGraphicsSubmodule{ 0x116f0cd7, 0x9584, 0x417e, { 0xba, 0x5e, 0x5e, 0xc6, 0x1e, 0x74, 0xc7, 0xe6 } };
