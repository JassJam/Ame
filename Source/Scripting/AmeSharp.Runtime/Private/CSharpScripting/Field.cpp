...
namespace Ame::Scripting
{
    static constexpr const char* ClassName =
        "AmeSharp.RuntimeHost.Runtime.FieldBridge, AmeSharp.RuntimeHost";
    ...
    void CLRRuntime::RegisterCommonFunctions_FieldBridge()
    {
        ...
        RegisterCommonFunction(Functions::FieldBridge_GetName,
                               GetFunctionPtr(ClassName, "GetName"));
        RegisterCommonFunction(Functions::FieldBridge_IsStatic,
                               GetFunctionPtr(ClassName, "IsStatic"));
        RegisterCommonFunction(Functions::FieldBridge_GetValue,
                               GetFunctionPtr(ClassName, "GetValue"));
        RegisterCommonFunction(Functions::FieldBridge_SetValue,
    ...
    {
        auto fieldFree =
            GetRuntime().GetCommonFunction<FreeFn>(CLRRuntime::Functions::FieldBridge_Free);
        fieldFree(m_Field);
    }
    ...
    {
        auto getName =
            GetRuntime().GetCommonFunction<GetNameFn>(CLRRuntime::Functions::FieldBridge_GetName);
    ...
    {
        auto isStatic =
            GetRuntime().GetCommonFunction<IsStaticFn>(CLRRuntime::Functions::FieldBridge_IsStatic);
    ...
    {
        auto getValue =
            GetRuntime().GetCommonFunction<GetValueFn>(CLRRuntime::Functions::FieldBridge_GetValue);
    ...
    {
        auto setValue =
            GetRuntime().GetCommonFunction<SetValueFn>(CLRRuntime::Functions::FieldBridge_SetValue);
        auto instanceHandle = instance ? static_cast<CSInstance*>(instance)->GetHandle() : nullptr;
