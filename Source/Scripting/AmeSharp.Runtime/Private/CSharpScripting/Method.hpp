...
namespace Ame::Scripting
{
    ...
    inline constexpr UId IID_CSMethod{ 0x2fa2bb0d,
                                       0x7355,
                                       0x4ad4,
                                       { 0x81, 0xce, 0xda, 0x38, 0xb0, 0xaf, 0xf9, 0x23 } };
    ...
    class CSMethod : public IMethod
    {
        ...
        using InvokeFn        = void (*)(void*        method,
                                  void*        instance,
    ...
    public:
        ...
        void InvokeMethod(IInstance*             instance,
