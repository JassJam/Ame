...
namespace Ame::Scripting
{
    static constexpr const char* ClassName =
        "AmeSharp.RuntimeHost.Runtime.TypeBridge, AmeSharp.RuntimeHost";
    ...
    void CLRRuntime::RegisterCommonFunctions_TypeBridge()
    {
        ...
        RegisterCommonFunction(Functions::TypeBridge_GetBaseType,
                               GetFunctionPtr(ClassName, "GetBaseType"));
        ...
        RegisterCommonFunction(Functions::TypeBridge_CreateInstance,
                               GetFunctionPtr(ClassName, "CreateInstance"));
        RegisterCommonFunction(Functions::TypeBridge_GetMethod,
                               GetFunctionPtr(ClassName, "GetMethod"));
        RegisterCommonFunction(Functions::TypeBridge_GetMethods,
                               GetFunctionPtr(ClassName, "GetMethods"));
        RegisterCommonFunction(Functions::TypeBridge_GetAttribute,
                               GetFunctionPtr(ClassName, "GetAttribute"));
        RegisterCommonFunction(Functions::TypeBridge_GetAttributes,
                               GetFunctionPtr(ClassName, "GetAttributes"));
        RegisterCommonFunction(Functions::TypeBridge_GetProperty,
                               GetFunctionPtr(ClassName, "GetProperty"));
        RegisterCommonFunction(Functions::TypeBridge_GetProperties,
                               GetFunctionPtr(ClassName, "GetProperties"));
        RegisterCommonFunction(Functions::TypeBridge_GetField,
                               GetFunctionPtr(ClassName, "GetField"));
        RegisterCommonFunction(Functions::TypeBridge_GetFields,
                               GetFunctionPtr(ClassName, "GetFields"));
    }
    ...
    {
        auto typeFree =
            GetRuntime().GetCommonFunction<FreeFn>(CLRRuntime::Functions::TypeBridge_Free);
        typeFree(m_Type);
    }
    ...
    {
        auto typeGetName =
            GetRuntime().GetCommonFunction<GetNameFn>(CLRRuntime::Functions::TypeBridge_GetName);
        return typeGetName(m_Type);
    }

    Ptr<IType> CSType::GetBaseType() const
    {
        auto typeGetBaseType = GetRuntime().GetCommonFunction<GetBaseTypeFn>(
            CLRRuntime::Functions::TypeBridge_GetBaseType);
    ...
    {
        auto typeCastAs =
            GetRuntime().GetCommonFunction<CastAsFn>(CLRRuntime::Functions::TypeBridge_CastAs);
    ...
    {
        auto typeGetSize =
            GetRuntime().GetCommonFunction<GetSizeFn>(CLRRuntime::Functions::TypeBridge_GetSize);
        return typeGetSize(m_Type);
    }

    Ptr<IInstance> CSType::CreateInstanceRaw(std::span<void* const> args)
    {
        auto createInstance = GetRuntime().GetCommonFunction<CreateInstanceFn>(
            CLRRuntime::Functions::TypeBridge_CreateInstance);
    ...
    {
        auto getField =
            GetRuntime().GetCommonFunction<GetFieldFn>(CLRRuntime::Functions::TypeBridge_GetField);
    ...
    {
        auto getMethod = GetRuntime().GetCommonFunction<GetMethodFn>(
            CLRRuntime::Functions::TypeBridge_GetMethod);
    ...
    {
        auto getAttribute = GetRuntime().GetCommonFunction<GetAttributeFn>(
            CLRRuntime::Functions::TypeBridge_GetAttribute);
    ...
    {
        auto getProperty = GetRuntime().GetCommonFunction<GetPropertyFn>(
            CLRRuntime::Functions::TypeBridge_GetProperty);
    ...
    {
        auto getFields = GetRuntime().GetCommonFunction<GetFieldsFn>(
            CLRRuntime::Functions::TypeBridge_GetFields);
    ...
    {
        auto getMethods = GetRuntime().GetCommonFunction<GetMethodsFn>(
            CLRRuntime::Functions::TypeBridge_GetMethods);
    ...
    {
        auto getAttributes = GetRuntime().GetCommonFunction<GetAttributesFn>(
            CLRRuntime::Functions::TypeBridge_GetAttributes);
    ...
    {
        auto getProperties = GetRuntime().GetCommonFunction<GetPropertiesFn>(
            CLRRuntime::Functions::TypeBridge_GetProperties);
