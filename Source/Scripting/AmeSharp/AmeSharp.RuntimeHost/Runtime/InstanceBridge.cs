...
public unsafe partial class InstanceBridge
{
    ...
    [UnmanagedCallersOnly]
    public static void Invoke(nint instancePtr, UnmanagedNativeString name, nint args, ulong argCount, nint retPtr)
    {
    ...
    [UnmanagedCallersOnly]
    public static void GetField(nint instancePtr, UnmanagedNativeString name, nint retPtr)
    {
        var instance = Get(instancePtr)!;
    ...
    [UnmanagedCallersOnly]
    public static void GetProperty(nint instancePtr, UnmanagedNativeString name, nint retPtr)
    {
        var instance = Get(instancePtr)!;
