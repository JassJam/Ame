...
private:                                                                   \
    ...
    static void GLFW##name##Callback(                                      \
        Args... args)                                                      \
    {                                                                      \
        auto& self = Get();                                                \
...
public:                                                                    \
    ...
    [[nodiscard]] uint32_t Install_##name(                                 \
        FnTy&& callback)                                                   \
    {                                                                      \
        auto id = m_IdCounter++;                                           \
...
private:                                                                                        \
    ...
    public:
        ...
        AME_INSTALL_GLFW_CALLBACKS_WINDOW(GLFWtitlebarhittestfun, glfwSetTitlebarHitTestCallback, TitlebarHitTest, int, int, int*);
        ...
        AME_INSTALL_GLFW_CALLBACKS_WINDOW(GLFWframebuffersizefun, glfwSetFramebufferSizeCallback, WindowFrameBufferSize, int, int);
        AME_INSTALL_GLFW_CALLBACKS_WINDOW(GLFWwindowcontentscalefun, glfwSetWindowContentScaleCallback, WindowContentScale, float, float);
